...
function countdownTimer() {
	var startTime = "2020-02-22 11:00:00";
	var stopTime = "2020-02-22 14:00:00";
	var allTimeZones = ["Etc/GMT+12", "Etc/GMT+11", "Etc/GMT+10", "Etc/GMT+8", "Etc/GMT+7", "Etc/GMT+6", "Etc/GMT+5", "Etc/GMT+4", "Etc/GMT+3", "Etc/GMT+1", "Etc/GMT+0",
	...
	var buttonId = ["timerm12", "timerm11", "timerm10", "timerm08", "timerm07", "timerm06", "timerm05", "timerm04", "timerm03", "timerm01", "timerp00", "timerp01", "timerp02",
	"timerp03", "timerp04", "timerp4p5", "timerp05", "timerp5p5", "timerp5p3", "timerp06", "timerp6p5", "timerp07", "timerp08", "timerp09", "timerp11", "timerp14"];
	
	var buttonTimerId = ["displaytimerm12", "displaytimerm11", "displaytimerm10", "displaytimerm08", "displaytimerm07", "displaytimerm06", "displaytimerm05", "displaytimerm04", "displaytimerm03", "displaytimerm01", "displaytimerp00", "displaytimerp01", "displaytimerp02", "displaytimerp03",
	"displaytimerp04", "displaytimerp4p5", "displaytimerp05", "displaytimerp5p5", "displaytimerp5p3", "displaytimerp06", "displaytimerp6p5", "displaytimerp07", "displaytimerp08", "displaytimerp09", "displaytimerp11", "displaytimerp14"];
	
	var tzStrings = ["UTC -12", "UTC -11", "UTC -10", "UTC -08", "UTC -07", "UTC -06", "UTC -05", "UTC -04", "UTC -03", "UTC -01", "UTC +00", "UTC +01", "UTC +02",
	...
	for (var cnt = 0; cnt < allTimeZones.length; cnt++) {
		...
		document.getElementById(buttonId[cnt]).innerHTML = "<strong>" + tzStrings[cnt] + "</strong><br>L'évenement commence le: " + eventTime.local().format("DD-MM-YYYY à HH:mm") //+ " " + moment.tz(moment.tz.guess()).zoneAbbr(); Do MMMM YYYY à h:mm:ss
	}
	continueTimer();
